    ...
    try {
        if (code != null && contentFunc.includes(code)) {
            chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
                ...
                if (code === "scrollToPoint") {
                    messageOptions.frameId = 0; // Only main frame should be sent the scroll command. All other commands should go to all frames.
                }

                // Send a message to the content script in the active tab
                chrome.tabs.sendMessage(tabId, { message: code, arg2_0: m.arg2[0], arg2_1: m.arg2[1], arg2_2: m.arg2[2] }, messageOptions, (response) => {
